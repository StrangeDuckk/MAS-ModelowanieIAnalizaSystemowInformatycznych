...
public class MasKoncowyApplication {
    public static void main(String[] args) {
        START.context = SpringApplication.run(MasKoncowyApplication.class, args);

        Company.setMinCountrySalary(4000.0);

        // ======== wylistowanie wszystkich ofert ==========
        wylistowanieWszystkichOfert(START.context);

        // ======== wylistowanie wszystkich firm ==========
        wylistowanieWszystkichFirm(START.context);

        // ======== wylistowanie wszystkich kandydatow ==========
        wylistowanieWszystkichKandydatow(START.context);

        // ======== wylistowanie aplikacji konkretnego kandydata, po person_id ==========
        wylistowanieKandydataPoId(START.context,2);
